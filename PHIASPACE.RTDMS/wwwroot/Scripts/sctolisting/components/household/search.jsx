class HouseholdSearchData extends SearchData {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        ...
        return (
            <form id="searchForm" className="form-inline" style={{ display: "inline-block", width: "100%" }} method="GET" action="/SctoListing/Household">
                ...
                <div className="form-group pull-right">
                    <button id="exportButton" type="submit" className="btn btn-default"
                        onClick={(e) => {
                            e.preventDefault();
                            this.handleSearch(e, "/SctoListing/Household/Export");
                            return true;
