...
namespace PHIASPACE.RTDMS.DAL.MysqlDbService;
...
public partial class AimsMysqlDbContext : DbContext
{
    ...
    public virtual DbSet<RtdmsIssueStatus> RtdmsIssueStatuses { get; set; }

    public virtual DbSet<RtdmsIssueType> RtdmsIssueTypes { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<RtdmsIssueStatus>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity.ToTable("rtdms_issue_status");

            entity.Property(e => e.Id).ValueGeneratedNever();
            entity.Property(e => e.Name).HasMaxLength(50);
        });

        modelBuilder.Entity<RtdmsIssueType>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity.ToTable("rtdms_issue_type");
