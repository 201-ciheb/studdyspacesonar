...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            IEventService events, ISetUpService setUpService
        ...
        private async Task<LogoutViewModel> BuildLogoutViewModelAsync(string logoutId)
        {
            var vm = new LogoutViewModel { 
                ...
                PreviousUrl = Request.Headers["Referer"] };
            ...
            if (context?.ShowSignoutPrompt == false)
            {
                ...
                vm.ShowLogoutPrompt = true;// false;
                return vm;
            }
        ...
        private async Task<LoggedOutViewModel> BuildLoggedOutViewModelAsync(string logoutId)
        {
            ...
            var vm = new LoggedOutViewModel
            {
                ...
                PostLogoutRedirectUri = string.IsNullOrEmpty(logout?.PostLogoutRedirectUri) ? Url.Action("Index", "Home") : logout?.PostLogoutRedirectUri,
                ClientName = string.IsNullOrEmpty(logout?.ClientName) ? "STUDYSPACE" : logout?.ClientName,
